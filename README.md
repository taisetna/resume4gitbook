...
사람들과 소통을 좋아하는 편이라, 카카오톡이나 슬랙의 프로그래밍 채널을 통해 다양한 도메인의 개발자들과 교류를 하며, 개발자로서 보다 넓은 식견을 가지기 위해 노력하고 있습니다.
...
동일비전 입사 후 처음 맡았던 프로젝트로,Zebra사의 바코드 하드웨어 모듈\(이하 PL3307\)이 탑재된 자사 바코드 리더기와 연동하는 어플리케이션 개발을 담당.

프로젝트에서 담당했던 부분은 총 두 파트로 다음과 같음
